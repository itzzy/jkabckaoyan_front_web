...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.RuleListItem>[] = [
    ...
    {
      title: <FormattedMessage id="pages.searchTable.fullTime" defaultMessage="学校评级" />,
      dataIndex: 'fullTime',
      valueEnum: {
        全日制: {
          text: (
            <FormattedMessage
              id="pages.searchTable.fullTime.fullTime"
            />
          ),
          status: '全日制',
        },
        非全日制: {
          text: (
            <FormattedMessage id="pages.searchTable.fullTime.partTime"/>
          ),
          status: '非全日制',
        },
      }
    ...
    {
      title: <FormattedMessage id="pages.searchTable.trendAdmissionCount2022" defaultMessage="22年计划统招人数(研究方向)" />,
      dataIndex: 'trendAdmissionCount2022Text',
      valueType: 'textarea',
      hideInSearch: true
    },
    {
      title: <FormattedMessage id="pages.searchTable.trendAdmissionCount2021" defaultMessage="21年计划统招人数(研究方向)" />,
      dataIndex: 'trendAdmissionCount2021Text',
      valueType: 'textarea',
      hideInSearch: true
    },
    {
      title: <FormattedMessage id="pages.searchTable.trendAddon" defaultMessage= "变化数(研究方向)" />,
      dataIndex: 'trendAddonText',
      valueType: 'textarea',
      hideInSearch: true
    }
  ];
  ...
  return (
    <PageContainer>
      ...
      <ProTable<API.RuleListItem, API.PageParams>
        ...
        request={admissionCountSearchZSNew}
        columns={columns}
        // rowSelection={{
