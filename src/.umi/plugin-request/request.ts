// @ts-nocheck
/**
 * Base on https://github.com/umijs//data/code/suolongkaoyan_front_web-free_user/node_modules/umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from '/data/code/suolongkaoyan_front_web-free_user/node_modules/umi-request';
// @ts-ignore
...
import useUmiRequest, { UseRequestProvider } from '/data/code/suolongkaoyan_front_web-free_user/node_modules/@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from '/data/code/suolongkaoyan_front_web-free_user/node_modules/@ahooksjs/use-request/lib/types';
