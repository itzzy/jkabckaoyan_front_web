...
import {commonSearch, isTrailUser} from '@/services/ant-design-pro/api';
...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.RuleListItem>[] = [
    ...
    },
    {
      ...
      hideInSearch: true,
      sorter: (a, b) => {
        if(a.score23 === '整理中' && b.score23 !== '整理中'){
          return -1;
        }else if(a.score23 !== '整理中' && b.score23 === '整理中'){
          return 1;
        } else{
          return a.score23.localeCompare(b.score23);
        }
      }
    },
    {
    ...
    {
      title: <FormattedMessage id="pages.searchTable.24luqu" defaultMessage="24录取人数" />,
    ...
    //   width: 50,
    //   hideInSearch: true,
    //   sorter: (a, b) => a.luquCount22 - b.luquCount22,
    // },
    {
    ...
    {
      title: <FormattedMessage id="pages.searchTable.fushiLuquRatio22" defaultMessage="22年复录比" />,
      dataIndex: 'fushiLuquRatio22',
      valueType: 'textarea',
      hideInSearch: true,
      sorter: (a, b) => a.fushiLuquRatio.localeCompare(b.fushiLuquRatio),
    },
    ...
    {
      title: <FormattedMessage id="pages.searchTable.operationExamStr" defaultMessage="机试" />,
      dataIndex: 'operationExamStr',
      valueType: 'textarea',
      hideInSearch: true
    },
    {
