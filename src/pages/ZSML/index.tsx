...
import {getSchoolList, getSchoolListByRank, isTrailUser} from "@/services/ant-design-pro/api";
...
const Page: React.FC = () => {
  ...
  return <PageContainer>
    ...
    <Card>
      <Typography>
        <Title level={5}>24招生目录查询</Title>
        <div>
          <br/>
          <a href="https://b38ca83272ce8c91.share.mingdao.net/public/view/650cd7895d08767879b8e164? 计科学硕24-计科学硕24自定义查询">24计科学硕招生目录综合查询</a>
          <br/>
          <a href="https://b38ca83272ce8c91.share.mingdao.net/public/view/650ed0d15c083dc74325b2d2? 软工学硕24-软工学硕24招生目录综合查询">24软工学硕招生目录综合查询</a>
          <br/>
          <a href="https://b38ca83272ce8c91.share.mingdao.net/public/view/650f86fcfe61a1417b434841? 网安学硕24-表格1">24网安学硕招生目录综合查询</a>
          <br/>
          <a href="https://b38ca83272ce8c91.share.mingdao.net/public/view/650cd9bdfe61a1417b4344b6? 电子信息24-表格1">24电子信息（专硕）招生目录综合查询</a>
          <br/>
          <br />
          <br />
        </div>
    ...
    <Card>
      <Typography>
        <Title level={5}>近4年计算机类招生目录腾讯文档查看</Title>
        <div>
          <br/>
          <a href="https://docs.qq.com/s/AoOI-2_DqIQGKoUbBeyiDq">近4年计算机类专业招生目录汇总</a>
          <br />
          <br />
        </div>
      </Typography>
